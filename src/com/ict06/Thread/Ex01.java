...
public class Ex01 {
	public static void main(String[] args) {
		...
		// - Threaad(Runnable target, String name) : 이떄 name는 스레드 이름을 지정할 수 있다.
		// - Runnable 인터페이스를 인자로 받아서 처리

		// - Thread(String name) : 이때 name은 스레드 이름 지정할 수 있다.
		...
		// - sleep(long millis) : 1000이 1초를 의미하고, 잠시 대기상태로 빠져 있는 상태를 말한다.
		// - yield() : 수행중인 스레드 중 우선순위가 같은 다른 스레드에게 제어권을 넘기다.
		// - getName() : 스레드 이름 구하기
