...
public class Ex03 {
	public static void main(String[] args) {
		// 작업할 특정 위치지정에 파일지정
		String pathname = "C:" + File.separator + "Study" + File.separator + "javaStudy" + File.separator + "MyProject"
				+ File.separator + "io_text" + File.separator + "SSS.txt";
		...
		try {
			...
			pathname = "C:" + File.separator + "Study" + File.separator + "javaStudy" + File.separator + "MyProject"
					+ File.separator + "io_text";
